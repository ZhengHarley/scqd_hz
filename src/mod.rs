...
/// TODO: Use this to set the SCQD constants based on the target_pointer_width
///         AKA 32-bit or 64-bit systems
/// 
/// SCQD constants. 
/// 
/// These values must be a power of 2. They also must be smaller than the number of bits in 'usize'.
